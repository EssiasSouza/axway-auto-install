...
# Dezembro de 2023
# Este script tem o objetivo de fazer a instalação sem interação humana.
...
# Parando o serviço do EDI se estiver rodando.
sudo echo '-- Parando o serviço do EDI e aguardando 60 segundos.' >> $LOG_1
sudo sh /home/pi/Axway/Activator/Activator force-stop &
wait

# ===== Fazendo a remoção da pasta do Axway =====
...
# Retirando o comentário do autoStartAbastece.sh
